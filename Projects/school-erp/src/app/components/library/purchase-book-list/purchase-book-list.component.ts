...
export class PurchaseBookListComponent {
  ...
  editPurchase(obj: any) {
    this.router.navigate([`/admin/purchase-book/${this.loadData.replaceSpecialCharacter(this.localService.encrypt(obj.PurchaseId))}`])
  }
  ...
  exportToExcel() {
    ...
    setTimeout(() => {
      this.loadData.exportToExcel(this.table_1, "Purchase Book List " + this.loadData.loadDateTime(new Date()));
  ...
  getSupplierList() {
    var obj: RequestModel = {
      request: this.localService.encrypt(JSON.stringify({ PurchaseFor: PurchaseFor.Library })).toString()
    }
    this.dataLoading = true
  ...
  getPurchaseList() {
    ...
    var obj: RequestModel = {
      request: this.localService.encrypt(JSON.stringify({
        ...
        PurchaseFor: PurchaseFor.Library,
  ...
  getPurchaseBookDetail(purchase: PurchaseModel) {
    var obj: RequestModel = {
