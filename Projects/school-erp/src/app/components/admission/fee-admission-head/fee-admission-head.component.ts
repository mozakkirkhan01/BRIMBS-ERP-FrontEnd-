...
export class FeeAdmissionHeadComponent {
  ...
  @ViewChild('formFeeAdmissionHead') formFeeAdmissionHead: NgForm;
  resetForm() {
    this.FeeAdmissionHead = {};
    if (this.formFeeAdmissionHead) {
      this.formFeeAdmissionHead.control.markAsPristine();
      this.formFeeAdmissionHead.control.markAsUntouched();
    }
  }
  ...
  getFeeAdmissionHeadList() {
    ...
    this.formFeeAdmissionHead.control.markAllAsTouched();
    if (this.formFeeAdmissionHead.invalid) {
